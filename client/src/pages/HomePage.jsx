...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Photograph your syllabus or dictate it with your voice — OCR and speech recognition built in.',
  },
  {
    icon: '🔍',
    title: 'Smart Topic Extraction',
    desc: 'AI analyzes and extracts topics from your syllabus so you can review before generating.',
  },
  {
    icon: '🧩',
    title: 'Interactive Quizzes',
    desc: 'Test your knowledge with AI-generated MCQ quizzes on any topic in your plan.',
  },
  {
    icon: '📊',
    title: 'Plan Analytics',
    desc: 'Visualize weekly breakdowns, completion stats, quiz performance, and study hours.',
  },
  {
    icon: '🔗',
    title: 'Share & Export',
    desc: 'Share your plan via unique links or export it as a beautifully formatted PDF document.',
  },
  {
    icon: '✏️',
    title: 'Drag & Drop Editor',
    desc: 'Rearrange days, edit topics, add custom days — full control over your study plan.',
  },
  {
    icon: '💡',
    title: 'AI Study Tips',
    desc: 'Click any topic for instant AI-generated tips, mnemonics, and practice questions.',
  },
  {
    icon: '🔒',
    title: 'Secure Accounts',
    desc: 'JWT authentication keeps your plans private. Dashboard tracks all your stats.',
  },
];
